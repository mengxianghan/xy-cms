        ...
        <a-row :gutter="16">
            <a-col :md="5" :xs="24">
                <a-card :bordered="false">
                    <x-info-column ref="informationColumn"
                                    :selected-keys="selectedKeys"
                                    @select="handleSelect"
                                    @complete="onInfoColumnComplete"></x-info-column>
                </a-card>
            </a-col>
            <a-col :md="19" :xs="24">
                <a-card :bordered="false">
                    <div class="table-page-search mb-2">
    ...
    export default {
        ...
        methods: {
            ...
            handleSelect(selectedKeys) {
                const columnId = this.$xy.util.getFieldsValue(this.$refs.informationColumn.list, {
