                        ...
                        <a-card-meta :title="item.name">
                            ...
                            <template slot="description">
                                <a-descriptions :column="1">
                                    <a-descriptions-item label="微信号">{{item.account||'-'}}</a-descriptions-item>
                                    <a-descriptions-item label="AppId">{{item.app_id||'-'}}
                                    </a-descriptions-item>
                                    <a-descriptions-item label="AppSecret">{{item.app_secred||'-'}}
                                    </a-descriptions-item>
                                </a-descriptions>
                            </template>
                        </a-card-meta>
