...
<script>
    ...
    export default {
            ...
            this.form = this.$form.createForm(this, {
                onValuesChange: (_, values) => {
                    ...
                    if (values.dict_dir_id) {
                        const data = this.$xy.util.treeToList(this.$parent.dictDirList).filter(item => item.id === values.dict_dir_id)
                        if (data.length) {
        ...
        computed: {
            treeData() {
                return this.$xy.util.changeKeys(this.$parent.dictDirList)
            }
        },
        methods: {
            /**
