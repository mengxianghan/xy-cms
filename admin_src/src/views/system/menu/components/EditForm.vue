...
<script>
    ...
    export default {
        ...
        computed: {
             ...
             */
            disabledId() {
                return this.$xy.util.getFieldsValue(this.$parent.list, {
            ...
            treeData() {
                return [{
                    ...
                    value: '0',
                    key: '0'
                }, ...this.$xy.util.changeKeys(this.$parent.list, {
                    title: "name",
                    value: "id",
                    key: "id",
                    children: "children",
            ...
            handleEdit(record) {
                ...
                this.$nextTick(() => {
                    this.form.setFieldsValue({
                        ...
                        auth_button_id: this.$xy.util.stringToArray(record.auth_button_id),
                        hidden: this.$xy.util.stringToBoolean(record.hidden),
                ...
                this.form.validateFieldsAndScroll((err, values) => {
                    if (!err) {
                        ...
                        this.$api.system.menu.submit({
                            ...
                            auth_button_id: this.$xy.util.arrayToString(values.auth_button_id),
                            hidden: this.$xy.util.booleanToString(values.hidden),
