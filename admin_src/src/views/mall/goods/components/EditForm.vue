            ...
            <div class="goods-drawer__form">
                <a-form :form="form"
                    ...
                    <a-form-item label="商品卖点"
                                 extra="在商品详情页标题下面展示卖点信息，建议60字以内">
                    ...
                    <a-form-item label="划线价"
                        ...
                        <a-input v-decorator="['crossed_price']"
                                 addon-before="¥"
                                 addon-after="元"></a-input>
                    </a-form-item>
                    ...
                    <a-form-item label="库存"
                                 extra="库存为 0 时，会放到『已售罄』的商品列表里，保存后买家看到的商品可售库存同步更新">
                    ...
                    <a-form-item label="快递运费">
                        <a-radio-group v-decorator="['freight_type',{initialValue:'1'}]">
                            <a-row>
                                <a-col :span="6">
    ...
    export default {
        ...
        methods: {
            ...
            async getCategoryList() {
                ...
                if (code === '200') {
                    this.categoryList = this.$xy.util.changeKeys(list, {
                        title: "name",
                        value: "id",
                        key: "id",
                        children: "children"
            ...
            async getClassifyList() {
                ...
                if (code === '200') {
                    this.classifyList = this.$xy.util.changeKeys(list, {
                        title: "name",
                        value: "id",
                        key: "id",
                        children: "children"
