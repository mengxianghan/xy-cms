    ...
    export default {
        ...
        methods: {
            ...
            async getColumnList() {
                ...
                if (code === '200') {
                    this.columnList = this.$xy.util.changeKeys(list)
                }
            },
            /**
             * 新增
            ...
            handleEdit(record) {
                ...
                this.$nextTick(() => {
                    this.form.setFieldsValue({
                        ...
                        url: record.url,
                        tags: this.$xy.util.stringToArray(record.tags),
                        is_recommend: this.$xy.util.stringToBoolean(record.is_recommend),
                        is_hot: this.$xy.util.stringToBoolean(record.is_hot),
                ...
                this.form.validateFieldsAndScroll((err, values) => {
                    if (!err) {
                        ...
                        this.$api.information.news.submit({
                            ...
                            url: values.url,
                            tags: this.$xy.util.arrayToString(values.tags),
                            is_recommend: this.$xy.util.booleanToString(values.is_recommend),
                            is_hot: this.$xy.util.booleanToString(values.is_hot),
